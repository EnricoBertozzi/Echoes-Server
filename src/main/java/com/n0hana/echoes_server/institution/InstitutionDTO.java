 ...
 * @param name          Razão social da instituição (autoridade: Receita Federal quando verificada)
 * @param nomeFantasia  Nome fantasia retornado pela Receita Federal (opcional, autopreenchido)
 * @param acronym       Acrônimo da instituição
